import{c as a,Q as n,j as p,m as t}from"./chunks/framework.B1f5Gm19.js";const k=JSON.parse('{"title":"架构设计","description":"","frontmatter":{"title":"架构设计"},"headers":[],"relativePath":"developer/architecture.md","filePath":"developer/architecture.md","lastUpdated":1779159134000}'),e={name:"developer/architecture.md"};function i(l,s,d,c,o,r){return n(),p("div",null,[...s[0]||(s[0]=[t(`<h1 id="架构设计" tabindex="-1">架构设计 <a class="header-anchor" href="#架构设计" aria-label="Permalink to &quot;架构设计&quot;">​</a></h1><p>本文从高层视角介绍 Trojan-Go 的系统设计和数据流。</p><h2 id="核心设计原则" tabindex="-1">核心设计原则 <a class="header-anchor" href="#核心设计原则" aria-label="Permalink to &quot;核心设计原则&quot;">​</a></h2><p>Trojan-Go 的核心设计是<strong>可插拔隧道栈</strong>（Pluggable Tunnel Stack）。每个功能模块（TLS、WebSocket、Trojan 协议、路由等）都实现为独立的隧道层，通过组合不同的隧道层构成完整的代理功能。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌─────────────────────────────────────────┐</span></span>
